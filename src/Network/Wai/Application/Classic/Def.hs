...
defaultClassicAppSpec =
    ClassicAppSpec
    {softwareName = "Classic", statusFileDir = "/usr/local/share/html/status/"}
...
defaultFileAppSpec =
    FileAppSpec {indexFile = "index.html", isHTML = defaultIsHTml}
...
defaultCgiAppSpec = CgiAppSpec {indexCgi = "index.cgi"}
